...
#'   value or rely on sample size only.
#'
...
#'
#' \code{ss.power.spa} assumes that the planned study will have equal n. Unequal
#' n in the previous study is handled in the following way for split plot
#' designs. If the user enters an N not divisible by the number of
#' between-subjects cells, the function calculates n by dividing N by the number
#' of between-subjects cells and both rounding up and rounding down the result.
